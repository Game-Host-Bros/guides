...
description: Learn how to add pak0 files to your Quake 3 Arena dedicated server.
sidebar:
  label: Add Custom Maps
---
import { Steps } from '@astrojs/starlight/components';

Quake 3 Arena has lots of great base maps, but sometimes you want something different. In this guide, I'll show you how to add custom maps to your [Quake 3 Arena server](https://www.gamehostbros.com/quake-3-arena-server-hosting/).
...
2. Access the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your Quake 3 Arena server.
3. In the sidebar click on `Management > File Manager`.
4. Navigate to the `baseq3` folder.
5. Here, upload your custom map .pk3 file. You can drag and drop the file from your local computer, or use an FTP client to upload the file.
