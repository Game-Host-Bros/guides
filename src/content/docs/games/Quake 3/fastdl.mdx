...
[Quake 3 Arena](https://www.gamehostbros.com/quake-3-arena-server-hosting/) by default doesn't let players download from your server, but at Game Host Bros, we have your server set to `sv_allowDownload 1`. This means that any player can join and download maps.
