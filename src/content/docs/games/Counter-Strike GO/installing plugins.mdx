...
Installing plugins on your Counter-Strike: Global Offensive server can enhance gameplay and add new features. **By default, Game Host Bros CSGO servers come with Metamod, Sourcemod preinstalled**. We also preconfigure Cleaner to remove any messages about needing to update your server after CS2's launch. 
