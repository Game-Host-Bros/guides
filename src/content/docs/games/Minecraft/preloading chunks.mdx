...
description: Learn how to pregenerate chunks on your Minecraft Server
sidebar:
  label: Preloading Chunks
---
import { Steps } from '@astrojs/starlight/components';

This is what you do if you want to preload chunks on your Minecraft Server, preloading chunks is a great way to help minimize performance issues if your server is having trouble loading too many chunks while you're trying to explore.
...
<Steps>
  ...
  4. To start the generation type `chunky start <world name>`.
</Steps>

By default `world` will generate the overworld, while `world_nether` and `world_the_end` will generate their respective zones.
