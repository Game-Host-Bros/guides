...
<Steps>
    ...
    - **Port**: Enter The port number for your minecraft Server (Example: `25565`)
    - **Target**: The hostname you wish the service to be on. (Example: `minecraft.domain.tld`)
<Steps>
...
```
  _Minecraft._tcp.domain.tld SRV 1 1 25565 Minecraft.domain.tld
```

Now, users connecting to `minecraft.domain.tld` will automatically be directed to **your Minecraft Server IP** on port `25565`.
