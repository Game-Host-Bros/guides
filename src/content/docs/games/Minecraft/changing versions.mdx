...
:::danger
Format will delete all of your files to make sure the version changes successfully. Download a [Backup](/getting-started/backups/) if you have anything you want to keep!
:::
