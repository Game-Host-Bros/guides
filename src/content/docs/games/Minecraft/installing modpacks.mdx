...
<Steps>
  ...
  4. Use [SFTP](/getting-started/uploading-files) and upload the Modpack.zip to your servers home directory.
...
- Make sure the upload was successful, files larger than 1GB need to be uploaded using [SFTP](/getting-started/uploading-files).
