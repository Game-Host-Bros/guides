...
These are the next steps after you've downloaded the Modpack of choice, do note that some modpacks may have a Client and Server version, in this case make sure you've downloaded the Server files. We recommend a launcher such as Prism Launcher to install Modpacks to your game client.
...
6. Go into `Configuration > Startup Parameters` and make sure `Server Jar File` matches the .jar file from the Modpack.
