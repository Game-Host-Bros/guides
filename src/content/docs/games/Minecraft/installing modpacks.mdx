...
<Steps>
  ...
  5. Once uploaded `Decompress` the  Modpack.zip by clicking the three dots in `Management > File Manager`.
     - Uploading a .zip is preferred as it's faster, but you can also upload everything uncompressed if you're having trouble.
     - The upload location will be the home directory of your server, for most Forge versions when you click File Manager it should look something like this.
     <FileTree>
     - File-Manager
       - **forge-wrapper.jar** 
       - **libraries**
