...
<Steps>
  1. Find the link for the Modpack you want from [CurseForge](https://www.curseforge.com/minecraft/modpacks/)
  2. Log into the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your Minecraft server.
  3. Go to `Configuration > Startup Parameters` and select `Mods`
  4. Look for `Modpack URL` and paste in your link and restart your server.
</Steps>
