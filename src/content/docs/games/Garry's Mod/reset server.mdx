---
title: How To Reset Your GMOD Server
description: Learn how to totally reset your GMOD dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [GMOD server](https://www.gamehostbros.com/gmod-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
