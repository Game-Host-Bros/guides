...
If you need to know what all the settings do, we have a [PDF that you can download here](https://cdn.stunlock.com/blog/2022/05/25083113/Game-Server-Settings.pdf). This is released by the game developers that contains all the settings and descriptions.