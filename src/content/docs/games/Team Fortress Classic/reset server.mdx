---
title: How To Reset Your Team Fortress Classic Server
description: Learn how to totally reset your Team Fortress Classic dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Team Fortress Classic server](https://www.gamehostbros.com/team-fortress-classic-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
