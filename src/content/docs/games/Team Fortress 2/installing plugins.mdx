...
description: Learn how to install plugins and extensions for your Team Fortress 2 dedicated server.
sidebar:
  label: Install Plugins
---
import { Steps } from '@astrojs/starlight/components';

Installing plugins on your [Team Fortress 2 server](https://www.gamehostbros.com/team-fortress-2-server-hosting/) can enhance gameplay and add new features. Game Host Bros makes it easy to enable SourceMod, which is required for most plugins.
