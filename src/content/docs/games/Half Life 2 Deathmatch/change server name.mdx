---
title: How To Change Your Half Life 2 Deathmatch Server Name
...
This is what you do if you need to change your server name on your [Half Life 2 Deathmatch server](https://www.gamehostbros.com/half-life-2-deathmatch-server-hosting/), also referred to as a hostname. This is what is displayed to players in the server browser.
<Steps>
