---
title: How To Setup FastDL For Your Half Life 2 Deathmatch Server
...
At Game Host Bros, we offer FastDL for your [Half Life 2 Deathmatch server](https://www.gamehostbros.com/half-life-2-deathmatch-server-hosting/) so players can download custom files such as maps, models and materials quickly. Everything is automatic and there is no extra configuration required on your end other than uploading your custom content. 
