---
title: How To Reset Your Deadlock Server
description: Learn how to totally reset your Deadlock dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Deadlock server](https://www.gamehostbros.com/quake-3-arena-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
