...
Currently there are no commands that allow you to run a match like normal online matchmaking. We have a [Game Preset](/deadlock/game-presets/) called 6v6_comp that will get you close to that experience but requires extra steps. 
