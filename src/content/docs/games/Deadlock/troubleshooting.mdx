...
## No Player Limits
There is no way to enforce player limits on Deadlock yet, this means that more than 12 people can join your server at ANY time. Only give out the IP address to people who are currently playing via DM. **DON'T** post your IP address publicly.
