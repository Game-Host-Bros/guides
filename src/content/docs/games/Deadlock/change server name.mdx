...
description: Learn how to change your server hostname on your Deadlock server.
sidebar:
  label: Change Server Name
---
import { Steps } from '@astrojs/starlight/components';

This is what you do if you need to change your server name on your Deadlock server, also referred to as a hostname. This is what is displayed to players in the server browser.
<Steps>
