...
Whenever a new update is detected your server will now automatically restart to perform the update. Note, this fully automatic feature isn't currently available for older servers, simply enable updates and then restart your server to apply an update.
