...
:::danger
You can only edit this file if you dont have all the settings in `Configuration > Startup Parameters`. Your server MUST be stopped before making changes to this file otherwise they won't save. Anything you edit in `Configuration > Startup Parameters` will override what is set in your config.
:::
