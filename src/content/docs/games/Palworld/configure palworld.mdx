...
1. Click [here](https://palworldoptions.com/) and import your `WorldOption.sav` file.
2. Login to the [Game Host Bros Panel](https://panel.gamehostbros.com/) and once there, select your Palworld Service.
3. Go to `Configuration > Startup Parameters` and change the settings to match your WorldOption.sav file.
4. Restart your server.
