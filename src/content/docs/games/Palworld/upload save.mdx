...
:::caution
If you have a WorldOptions.sav file in `PAL/Save/Savegames/0`, you must configure it to use our server settings or delete it. You can [configure it here.](/games/palworld/configure-palworld/)
:::
