...
The only way to [transfer your host character](/games/palworld/upload-save/#transferring-your-host-character) is to use 3rd party save modification tools.
:::
...
## Migrating A PC Game Pass Co-op Save
