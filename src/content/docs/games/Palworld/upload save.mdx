...
## Transfer From an PC Game Pass Co-op Save
...
6. Take the converted file, and once again drag it onto `convert.py`.
7. Rename the twice converted file to `Level.sav`.
8. Delete the `Level` folder in your save files, and drag the newly created `Level.sav` in.
9. Using [SFTP](/getting-started/uploading-files/) upload your existing save folder and copy the folder id/name.
