...
description: Discover how to effortlessly change maps on your 7 Days To Die dedicated server with our detailed step-by-step guide. Customize your gameplay experience today!
sidebar:
  label: Change Maps
---
...
3. Under `Map`, edit the `Game World` option to change the map to one of the following:
   ...
   - **Pregen Map**: The name of one a pregenerated map found below, or in `Data/Worlds`.
