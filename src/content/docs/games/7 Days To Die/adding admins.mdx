...
In this guide you will learn how to add admins to your [7D2D server](https://www.gamehostbros.com/7-days-to-die-server-hosting/). For this guide you will need to have your [SteamID64](https://steamid.io/).
