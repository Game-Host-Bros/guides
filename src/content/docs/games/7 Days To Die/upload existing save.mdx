...
2. Using [SFTP](/getting-started/uploading-files) navigate to `.local/share/7DaysToDie/GeneratedWorlds/` and upload your World. Following the example below.
3. For Save data. Again, using [SFTP](/getting-started/uploading-files) upload your Save to `.local/share/7DaysToDie/Saves/`.
</Steps>
