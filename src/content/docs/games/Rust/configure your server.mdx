---
title: How To Configure Your Rust Server
description: Learn how to change game settings and configure your Rust dedicated server
sidebar:
  label: Configure Your Server
---
import { Steps } from '@astrojs/starlight/components';

In this guide, we will show you how to edit settings on your [Rust server](https://www.gamehostbros.com/rust-server-hosting/).
...
Here's how to use the server.cfg configuration file to configure your server.

<Steps>

1. Access the [Game Host Bros Panel](https://panel.gamehostbros.com/) and stop your Rust server.
2. In the sidebar, click `Management > File Manager` and navigate to `server/rust/cfg/server.cfg`.
3. Make your desired changes and then click save.
4. Restart your server.
</Steps>

:::note
If the settings exist in Startup Parameters, then they will override what is manually set in the configuration file.
:::

Here's a list of some settings that can be configured in server.cfg according to the [Rust Dedicated Server Wiki](https://developer.valvesoftware.com/wiki/Rust_Dedicated_Server).

<details>
<summary>Rust Settings List</summary>
