...
description: Learn how to ban players on your Rust dedicated server.
sidebar:
  label: Banning Players
---
import { Steps } from '@astrojs/starlight/components';

Here is how to ban, or unban, a player on your [Rust server](https://www.gamehostbros.com/rust-server-hosting/).

## How to Ban a Player
<Steps>
1. Access the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your Rust server.
2. In the console type `/ban "user_name" ["optional_reason"]`. 
</Steps>
...
<Steps>
1. Access the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your Rust server.
2. In the console type `/unban user_ID`
</Steps>
