...
:::note
You can also install some of the mod common Rust plugins directly from our panel by going to `Tools > Mod Manager`. Some of these may require additional configuration.
:::
