---
title: How To Reset Your Rust Server
description: Learn how to totally reset your Rust dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Rust server](https://www.gamehostbros.com/rust-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
