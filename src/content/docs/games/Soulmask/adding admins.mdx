...
description: Learn how to add admins to your Soulmask dedicated server.
sidebar:
  label: Adding Admins
---
import { Steps } from '@astrojs/starlight/components';

Here is how to add admins to your [Soulmask server](https://www.gamehostbros.com/soulmask-server-hosting/). In Soulmask admins are able to quickly change server settings via the in-game admin panel.

## Setting An Admin Password In Soulmask
