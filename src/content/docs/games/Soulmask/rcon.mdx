...
For security reasons, RCON uses an IP whitelist. Only whitelisted IP addresses can connect to the server's RCON service. We also dont allow access to this publicly unless requested via a support ticket
