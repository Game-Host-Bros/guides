...
If you're using [NMRiH plugins](/games/no-more-room-in-hell/installing-plugins/) such as Sourcemod, each plugin you install should generate a config file inside the Sourcemod `/addons/sourcemod/configs/` folder. Some plugins may put their config file in `/nmrih/cfg/sourcemod/`. If you're in doubt, you'll need to refer to the plugin authors documentation.
