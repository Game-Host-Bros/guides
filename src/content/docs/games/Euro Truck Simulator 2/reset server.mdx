---
title: How To Reset Your ETS 2 Server
description: Learn how to totally reset your ETS 2 dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [ETS 2 server](https://www.gamehostbros.com/euro-truck-simulator-2-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
