...
Here is how you can reset your [ETS 2 server](https://www.gamehostbros.com/ETS 2-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
