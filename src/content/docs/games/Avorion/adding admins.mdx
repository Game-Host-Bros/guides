...
:::note
You can also enter the SteamID64 of single user in the `Configuration > Startup Parameters` menu of the [Game Host Bros Panel](https://panel.gamehostbros.com/), in the `Admin ID` setting.
:::
