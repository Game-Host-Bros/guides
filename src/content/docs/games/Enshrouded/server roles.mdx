...
In this guide you will learn how to setup custom permissions and groups for your [Enshrouded server](https://www.gamehostbros.com/enshrouded-server-hosting/). This is designed for **advance users** who need granular control of their server.
