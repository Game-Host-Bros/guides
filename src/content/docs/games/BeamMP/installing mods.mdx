...
:::note
[SFTP](https://guides.gamehostbros.com/getting-started/uploading-files/) is the recommended way of uploading files to your server, especially if you're uploading multiple at once. SFTP is also required for files larger than 1GB in size.
:::
