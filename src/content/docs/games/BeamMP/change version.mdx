...
<Steps>
1. Find the version number you want to switch to from the [BeamMP Server Releases](https://github.com/BeamMP/BeamMP-Server/releases), e.g., `v3.7.2`.
...
4. Change the `BeamMP Server Version` to your desired version (e.g., `v3.7.2`).
