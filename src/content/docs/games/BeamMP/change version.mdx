...
description: Learn how to change the version of your BeamMP dedicated server to run an older or pre-release version.
sidebar:
  label: Change Server Version
---
import { Steps } from '@astrojs/starlight/components';

Sometimes, you might want to switch your [BeamMP server](https://www.gamehostbros.com/beammp-server-hosting/) to a different version. This could be to:
...
<Steps>
1. Find the version number you want to switch to from the [BeamMP Server Releases](https://github.com/BeamMP/BeamMP-Server/releases), e.g., `v3.8.1`.
...
4. Change the `BeamMP Server Version` to your desired version (e.g., `v3.8.1`).
