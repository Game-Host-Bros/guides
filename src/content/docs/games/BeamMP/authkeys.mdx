...
description: Learn how to create an AuthKey for your BeamMP dedicated server.
sidebar:
...
Here is how you create an AuthKey for [BeamMP](https://www.gamehostbros.com/beammp-server-hosting/) and add it to your server. This is **required** for your server to display in the server browser.
