...
BeamMP has had reported bugs regarding mod downloading for quite some time.

As of late new changes have been made to networking with newer BeamMP server versions, typically an issue such as this can be solved by updating your server to one a newer [BeamMP Server](https://github.com/BeamMP/BeamMP-Server/releases) pre-release version.
