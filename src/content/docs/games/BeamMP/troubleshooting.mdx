...
As of late new changes have been made to networking with newer BeamMP server versions, typically an issue such as this can be solved by updating your server.
