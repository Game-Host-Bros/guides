---
title: How To Play Steam Workshop Maps On Your Quake Live Server
description: Learn how to play Steam Workshop maps with friends on your Quake Live dedicated server.
sidebar:
  label: Play Workshop Maps
---
import { Steps } from '@astrojs/starlight/components';

Since [Quake Live](https://www.gamehostbros.com/quake-live-server-hosting/) doesn't support FastDL, you are required to use the Steam Workshop for downloading content. The benefit of this is your server and players will always have the same content.
