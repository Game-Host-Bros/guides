---
title: How To Reset Your Quake Live Server
description: Learn how to totally reset your Quake Live dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Quake Live server](https://www.gamehostbros.com/quake-live-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
