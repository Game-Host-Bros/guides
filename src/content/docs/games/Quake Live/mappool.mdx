...
description: Learn how to setup a map pool for your Quake Live dedicated server.
sidebar:
  label: Map Pool
---
import { Steps } from '@astrojs/starlight/components';

A crucial part of customizing your [Quake Live server](https://www.gamehostbros.com/quake-live-server-hosting/) on Game Host Bros is setting up a specific map pool. This guide explains how to configure your map pool and, if desired, lock your server to a single gametype.
