...
description: Learn how to install plugins your Quake Live dedicated server using MinQLX.
sidebar:
  label: Install Plugins
---
import { Steps } from '@astrojs/starlight/components';

In this guide you will learn how to install plugins on your [Quake Live server](https://www.gamehostbros.com/quake-live-server-hosting/) using MinQLX.
...
2. In the left-hand menu, go to `Configuration > Startup Parameters`.
3. Look for `MinQLX` and toggle it on.
4. Restart your Quake Live server.
</Steps>
...
3. Open the `minqlx-plugins` folder.
4. Drag your plugin .py file inside.
5. In the left-hand menu, go to `Configuration > Startup Parameters`.
6. Look for MinQLX Plugins and add your plugin name to the end of the list.
