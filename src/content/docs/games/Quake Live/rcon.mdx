...
description: Learn how to use RCON on your Quake Live dedicated server.
sidebar:
  label: RCON
---
import { Steps } from '@astrojs/starlight/components';

This guide provides step-by-step instructions on how to set up and manage your [Quake Live server](https://www.gamehostbros.com/quake-live-server-hosting/) using RCON.
