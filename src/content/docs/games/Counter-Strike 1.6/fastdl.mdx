...
At Game Host Bros, we offer FastDL for your Counter-Strike 1.6 server so players can download custom files such as maps, models and materials quickly. Everything is automatic and there is no extra configuration required on your end other than uploading your custom content. 
