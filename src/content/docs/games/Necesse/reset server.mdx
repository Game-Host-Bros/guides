---
title: How To Reset Your Necesse Server
description: Learn how to totally reset your Necesse dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Necesse server](https://www.gamehostbros.com/necesse-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
