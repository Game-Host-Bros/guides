...
1. [Connect](https://guides.gamehostbros.com/games/necesse/connect-to-server/) to your server
...
1. [Connect](https://guides.gamehostbros.com/games/necesse/connect-to-server/) to your server.
2. Open chat with `Enter` and input your command of choice, for example, `/kick [Name]`, for example `/pm [player]` sends a private message to the specified user.
...
|--------------------------------------------------|-------------|------------------------------------------------------------------------------------------------------|--------|
| /allowcheats                                    | Owner       | Enables cheats on this world (NOT REVERSIBLE!)                                                | Yes    |
...
| /demo [<player>] [<setup> [<forceNew>]] [<builds>] | Admin    | Setups up a world and/or build for player                                                             | Yes    |
