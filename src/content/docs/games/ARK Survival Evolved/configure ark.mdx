...
A full breakdown of settings can also be found on the [ARK SE Server Configuration Wiki](https://ark.fandom.com/wiki/Server_configuration#GameUserSettings.ini), this page also contains details on how to configure your Game.ini file, Game.ini is used for advanced configuration of an ARK server.
