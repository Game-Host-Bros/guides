...
After finding your desired mods from [https://mods.factorio.com/](https://mods.factorio.com/), here's how to install them on your server.

<Steps>
1. Load the [Game Host Bros Panel](https://panel.gamehostbros.com/) and `Stop` your Factorio server.
2. In the left-hand menu, click `Management > File Manager`.
3. Open the `Mods` folder
4. Drag the mods you want to add into this folder and restart your server. (Limited to 1GB, otherwise use [SFTP](/getting-started/uploading-files/).
   <FileTree>
...
Once installed, you can simply join the server afterwards, and it will automatically download them to your game client.
