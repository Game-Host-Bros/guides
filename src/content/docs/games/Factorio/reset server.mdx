---
title: How To Reset Your Factorio Server
description: Learn how to totally reset your Factorio dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Factorio server](https://www.gamehostbros.com/factorio-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
