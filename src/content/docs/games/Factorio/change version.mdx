...
We don't recommend using your current save or any mods on a previous version of Factorio, or loading an old save on a much newer version as it will likely be incompatible. However, if you still want to try, we suggest first manually downloading a backup of your save from `/saves`. After that, delete all files on your server, and then reinstall your server, once reinstalled, reupload your save.
