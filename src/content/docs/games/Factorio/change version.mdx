...
We don't recommend using your current save or any mods on an older version of Factorio. However, if you still want to try, you must first manually download a backup of your save before proceeding with the steps below.
...
3. Edit `Factorio Version` and `Save Name`.
