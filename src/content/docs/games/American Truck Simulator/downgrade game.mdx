...
:::tip
Do you also want to change your server version? Follow [this guide](/games/american-truck-simulator/change-server-version/) to downgrade your ATS server version.
:::