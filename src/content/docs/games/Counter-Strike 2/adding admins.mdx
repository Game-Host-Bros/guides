---
title: How To Add Admins In Counter-Strike 2
description: In this guide we will show you how you can add admins on your Counter-Strike 2 dedicated server
sidebar:
  label: Adding Admins
---

One of the biggest struggles we've seen with new CS2 server owners is setting up admin perms on their new server. At Game Host Bros, we've made it so our panel will take care of creating all the admin and group files that are needed.
