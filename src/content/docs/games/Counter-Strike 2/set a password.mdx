...
description: Learn how to set a password on your CS2 dedicated server.
sidebar:
  label: Setting a Password
---
import { Steps } from '@astrojs/starlight/components';

This is what you do if you need to set a password on your [Counter Strike 2 server](https://www.gamehostbros.com/cs2-server-hosting/).

## Setting Your CS2 Server Password
