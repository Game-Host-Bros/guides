...
description: Learn how to setup automatic updates for your CS2 dedicated server.
sidebar:
  label: Automatic Updates
---
import { Steps } from '@astrojs/starlight/components';

At Game Host Bros, we have true automatic updates for [Counter Strike 2](https://www.gamehostbros.com/cs2-server-hosting/). This means as soon as an update comes out, within 120 seconds your server will send a message to all the players on the server and restart it.
...
3. Find `Automatic Updates` and toggle it to the desired position and restart your server.
</Steps>
...
1. Log in to the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your server.
2. Go to `Configuration > Startup Parameters`.
3. Find and change the `Automatic Update Message` field and restart your server.
</Steps>
...
2. Log in to the [Game Host Bros Panel](https://panel.gamehostbros.com/) and select your server.
