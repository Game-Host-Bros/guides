...
description: Learn how to play workshop maps with friends on your CS2 dedicated server.
sidebar:
  label: Play Workshop Maps
---
import { Steps } from '@astrojs/starlight/components';

There are 2 different methods you can use for workshop maps in [CS2](https://www.gamehostbros.com/cs2-server-hosting/). One is by loading a single map or creating a collection.
...
:::note
Your collection must be active, approved and set public to work on a server. Collections are also limited to 100 maps. If you have more than 100 maps your entire collection will fail to load.
:::
