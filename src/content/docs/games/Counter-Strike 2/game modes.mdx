...
description: Learn how to change the game modes on your CS2 dedicated server.
sidebar:
  label: Game Modes
---
import { Steps } from '@astrojs/starlight/components';

Here is how you change your [CS2 server](https://www.gamehostbros.com/cs2-server-hosting/) Game Mode from Competitive to something else.
<Steps>
