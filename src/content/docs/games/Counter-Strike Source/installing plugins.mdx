...
description: Learn how to install plugins and extensions for your Counter-Strike Source dedicated server.
sidebar:
  label: Install Plugins
---
import { Steps } from '@astrojs/starlight/components';

Installing plugins on your [CSS server](https://www.gamehostbros.com/counter-strike-source-server-hosting/) can enhance gameplay and add new features. Game Host Bros makes it easy to enable SourceMod, which is required for most plugins.
