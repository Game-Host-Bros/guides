---
title: How To Reset Your Half Life Server
description: Learn how to totally reset your Half Life dedicated server.
sidebar:
  label: Reset Server
---
import { Steps } from '@astrojs/starlight/components';

Here is how you can reset your [Half Life server](https://www.gamehostbros.com/half-life-1-server-hosting/) to start completely fresh with a new save, this is helpful in case you've made a mistake that cannot be undone.
