...
5. Select a `Host` that is closest to your server and give the database a name.
6. Locate the plugin you'd like to use the MySQL database for. Open the plugin's configuration file and input the database details correctly.
